...
This project is indexed by GitNexus as **AGT_Brain** (6351 symbols, 11095 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
