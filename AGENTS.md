...
This project is indexed by GitNexus as **AGT_Brain** (5447 symbols, 9484 relationships, 264 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
